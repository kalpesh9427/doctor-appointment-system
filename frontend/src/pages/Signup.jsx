...
const STYLES = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .lg-left-h {
    ...
    font-weight: 700; line-height: 1.15; color: #fff; margin-bottom: 18px; letter-spacing: -0.02em;
  }
  ...
  .lg-trust-row { display: flex; gap: 24px; flex-wrap: wrap; }
  .lg-trust-item { display: flex; flex-direction: column; gap: 3px; }
  .lg-trust-num {
    font-family: 'Playfair Display', serif; font-size: 1.5rem; font-weight: 700; color: #fff; line-height: 1;
  }
  .lg-trust-lbl {
  ...
  .lg-trust-divider {
    width: 1px; background: rgba(255,255,255,0.2); align-self: stretch; margin: 0 4px;
  }
  ...
  .lg-card-sub {
    font-size: 0.9rem; color: var(--ink-3); font-weight: 300; margin-bottom: 32px; line-height: 1.6;
  }
  ...
  .lg-input-wrap:focus-within {
    border-color: var(--purple); box-shadow: 0 0 0 3px rgba(107,101,229,0.1);
  }
  ...
  .lg-eye {
    ...
    padding: 0; transition: color .14s; flex-shrink: 0;
  }
...
const Signup = () => {
  const { navigate, user, setUser, setLoading, loading, setDoctor } = useContext(AppContext);
      ...
      <div className="lg-root">
        ...
        <div className="lg-left">
          ...
          <div className="lg-left-content">
            <div className="lg-left-tag">Join Our Community</div>
            <h2 className="lg-left-h">
              Start Your <br /><em>Journey</em> With Us
            </h2>
            <p className="lg-left-sub">
              Create an account to book appointments, manage your 
              records, and get the care you deserve.
            </p>
        ...
        <div className="lg-right">
          <div className="lg-card">
            <h1 className="lg-card-title">Create <em>Account</em></h1>
            <p className="lg-card-sub">Please sign up to continue</p>
            ...
            <div className="lg-signup-row">
              ...
              <Link to="/login" className="lg-signup-link">Login here →</Link>
            </div>
          </div>
        </div>
      </div>
